Shader "Skybox/Volumetric Clouds"
{
    // ... Your Properties block should go here (not shown in your snippet) ...
    Properties
    {
        // ALL your properties like _SmallScale, _SunDirection, etc.
        _SmallScale ("Small Scale", Range(0.1, 10)) = 2.0
        // ... copy ALL your other properties here ...
    }
